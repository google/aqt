...
from google3.third_party.google_research.google_research.aqt.jax.imagenet import input_pipeline
from google3.third_party.google_research.google_research.aqt.jax.imagenet import models
from google3.third_party.google_research.google_research.aqt.jax.imagenet import train_utils as imagenet_train_utils
from google3.third_party.google_research.google_research.aqt.jax.imagenet.configs.paper.resnet50_w8_a8_auto import get_config as w8a8auto_paper_config
from google3.third_party.google_research.google_research.aqt.utils import hparams_utils as os_hparams_utils
from google3.third_party.google_research.google_research.aqt.utils import report_utils
from google3.third_party.google_research.google_research.aqt.utils import summary_utils
...
def estimate_compute_and_memory_cost(image_size, model_dir, hparams) -> None:
  ...
  with gfile.Open(model_dir / gpath.GPath(COMPUTE_MEMORY_COST_FILENAME),
                  'w') as file:
...
def prepare_and_save_report(hparams: hparams_config.TrainingHParams,
                            eval_freq: int, num_train_steps: int) -> None:
  ...
  report = report_utils.create_end_of_training_report(
      model_dir=gpath.GPath(FLAGS.model_dir),
      xid=FLAGS.xm_xid,
      eval_freq=eval_freq,
