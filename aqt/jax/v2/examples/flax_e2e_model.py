...
class CNN(nn.Module):
  ...
  quant_mode: aqt_flax_constant.QuantMode = aqt_flax_constant.QuantMode.TRAIN
...
def serving_conversion(train_state):
  ...
  cnn_freeze = CNN(
      bn_use_stats=False,
      aqt_cfg=aqt_cfg,
      quant_mode=aqt_flax_constant.QuantMode.CONVERT,
  )
  ...
  cnn_serve = CNN(
      bn_use_stats=False,
      aqt_cfg=aqt_cfg,
      quant_mode=aqt_flax_constant.QuantMode.SERVE,
  )
