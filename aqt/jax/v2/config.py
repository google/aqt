...
def fully_quantized(
  ...
  # Stochastic Rounding
  old_sr = use_stochastic_rounding is not None
  new_sr_lhs = vjp_lhs_stochastic_rounding is not None
  new_sr_rhs = vjp_rhs_stochastic_rounding is not None
  assert new_sr_lhs == new_sr_rhs
  assert new_sr_lhs != old_sr
