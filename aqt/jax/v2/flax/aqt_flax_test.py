...
class AqtFlaxTest(parameterized.TestCase):
  ...
  @parameterized.parameters(
      ...
      (jnp.int4, jnp.int4, jnp.int4),
      (jnp.float8_e4m3fn, jnp.float8_e4m3fn, jnp.float8_e4m3fn),
      (jnp.float8_e4m3fn, jnp.int8, jnp.bfloat16),
      (jnp.float8_e4m3fn, jnp.int4, jnp.float32),
      (jnp.float8_e4m3fn, jnp.bfloat16, jnp.bfloat16),
      (jnp.float8_e4m3fn, jnp.float32, jnp.float32),
      (jnp.float8_e5m2, jnp.float8_e5m2, jnp.float8_e5m2),
      (jnp.float8_e5m2, jnp.int8, jnp.bfloat16),
      (jnp.float8_e5m2, jnp.int4, jnp.float32),
      (jnp.float8_e5m2, jnp.bfloat16, jnp.bfloat16),
      (jnp.float8_e5m2, jnp.float32, jnp.float32),
      (jnp.float8_e5m2, jnp.float8_e4m3fn, jnp.bfloat16),
  )
