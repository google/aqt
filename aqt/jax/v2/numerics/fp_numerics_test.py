...
def fp_values(cfg: fp_numerics.FpNumericsConfig):
  ...
  assert nexp + nmant <= 16, f"{nexp=}, {nmant=}. Really! More than 16 bits?"
...
class FpTest(parameterized.TestCase):
  ...
  @parameterized.parameters([
      ...
      # Input is F32
      # FP4
      dict(nexp=3, minexp=0, nmant=0, has_subnormals=False, test_dtype=f32),
      dict(nexp=3, minexp=0, nmant=0, has_subnormals=True, test_dtype=f32),
      # dict(nexp=3, minexp=-2, nmant=0, has_subnormals=False, test_dtype=f32),
      # dict(nexp=3, minexp=-2, nmant=0, has_subnormals=True, test_dtype=f32),
      dict(nexp=2, minexp=0, nmant=1, has_subnormals=False, test_dtype=f32),
      dict(nexp=2, minexp=0, nmant=1, has_subnormals=True, test_dtype=f32),
      dict(nexp=1, minexp=0, nmant=2, has_subnormals=False, test_dtype=f32),
      dict(nexp=1, minexp=0, nmant=2, has_subnormals=True, test_dtype=f32),
      dict(nexp=0, minexp=0, nmant=3, has_subnormals=False, test_dtype=f32),
      dict(nexp=0, minexp=0, nmant=3, has_subnormals=True, test_dtype=f32),
      # FP6
      dict(nexp=5, minexp=0, nmant=0, has_subnormals=True, test_dtype=f32),
      dict(nexp=5, minexp=0, nmant=0, has_subnormals=False, test_dtype=f32),
      dict(nexp=4, minexp=0, nmant=1, has_subnormals=True, test_dtype=f32),
      dict(nexp=4, minexp=0, nmant=1, has_subnormals=False, test_dtype=f32),
      dict(nexp=3, minexp=0, nmant=2, has_subnormals=True, test_dtype=f32),
      dict(nexp=3, minexp=0, nmant=2, has_subnormals=False, test_dtype=f32),
      dict(nexp=2, minexp=0, nmant=3, has_subnormals=True, test_dtype=f32),
      dict(nexp=2, minexp=0, nmant=3, has_subnormals=False, test_dtype=f32),
      dict(nexp=1, minexp=0, nmant=4, has_subnormals=True, test_dtype=f32),
      dict(nexp=1, minexp=0, nmant=4, has_subnormals=False, test_dtype=f32),
      dict(nexp=0, minexp=0, nmant=5, has_subnormals=True, test_dtype=f32),
      dict(nexp=0, minexp=0, nmant=5, has_subnormals=False, test_dtype=f32),
      # FP5
      dict(nexp=4, minexp=0, nmant=0, has_subnormals=True, test_dtype=f32),
      dict(nexp=4, minexp=0, nmant=0, has_subnormals=False, test_dtype=f32),
      dict(nexp=3, minexp=0, nmant=1, has_subnormals=True, test_dtype=f32),
      dict(nexp=3, minexp=0, nmant=1, has_subnormals=False, test_dtype=f32),
      dict(nexp=2, minexp=0, nmant=2, has_subnormals=True, test_dtype=f32),
      dict(nexp=2, minexp=0, nmant=2, has_subnormals=False, test_dtype=f32),
      dict(nexp=1, minexp=0, nmant=3, has_subnormals=True, test_dtype=f32),
      dict(nexp=1, minexp=0, nmant=3, has_subnormals=False, test_dtype=f32),
      dict(nexp=0, minexp=0, nmant=4, has_subnormals=True, test_dtype=f32),
      dict(nexp=0, minexp=0, nmant=4, has_subnormals=False, test_dtype=f32),
      # Misc
      dict(nexp=2, minexp=0, nmant=0, has_subnormals=False, test_dtype=f32),
  ])
  def test_fp_round(
      self,
      nexp,
  ...
  def test_fp_round_old_vs_new(
    ...
    for i in range(2**4):
      ...
      cnt += 2**28
      x = jnp.arange(start=2**28 * i, stop=2**28 * (i + 1), dtype=jnp.uint32)
