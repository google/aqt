...
def make_reference(
    ...
    field: str,
) -> Union[ml_collections.ConfigDict, ml_collections.FieldReference]:
...
def set_default_reference(child_config: ml_collections.ConfigDict,
                          parent_config: ml_collections.ConfigDict,
                          field: Union[str, List[str]],
                          *,
                          parent_field: Optional[str] = None) -> None:
...
def get_fp_config() -> ml_collections.ConfigDict:
  config = ml_collections.ConfigDict({
      "exp_min": int_ph(),
      "exp_max": int_ph(),
      "sig_bits": int_ph()
