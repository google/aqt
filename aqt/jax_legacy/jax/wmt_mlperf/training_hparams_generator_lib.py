...
from aqt.jax_legacy.jax.quantization import ActsBoundT
...
def parse_base_config_prec(prec: Optional[str]) -> QuantOps.PrecT:
...
def create_base_transformer_hparams(
    *,  #
    mlp_weight_prec: QuantOps.PrecT,
    embedding_weight_prec: QuantOps.PrecT,
    attention_weight_prec: QuantOps.PrecT,
    mlp_pos_inputs_prec: QuantOps.PrecT,
    mlp_pos_inputs_hyper: ActsBoundT,
    mlp_signed_inputs_prec: QuantOps.PrecT,
    mlp_signed_inputs_hyper: ActsBoundT,
    attention_kqv_inputs_prec: QuantOps.PrecT,
    attention_kqv_inputs_hyper: ActsBoundT,
    attention_out_inputs_prec: QuantOps.PrecT,
    attention_out_inputs_hyper: ActsBoundT,
    attention_act_q_inputs_prec: QuantOps.PrecT,
    attention_act_q_inputs_hyper: ActsBoundT,
    attention_act_k_inputs_prec: QuantOps.PrecT,
    attention_act_k_inputs_hyper: ActsBoundT,
    attention_act_probs_inputs_prec: QuantOps.PrecT,
    attention_act_v_inputs_prec: QuantOps.PrecT,
    attention_act_v_inputs_hyper: ActsBoundT,
    logits_inputs_prec: QuantOps.PrecT,
    logits_inputs_hyper: ActsBoundT,
    logits_via_embeddings: bool,
    num_layers: int,
    num_heads: int,
    emb_dim: int,
    qkv_dim: int,
...
def create_training_hparams_from_base_config(
    base_config: BaseConfig) -> training_hparams.TrainingHParams:
...
def create_training_hparams_from_flags() -> training_hparams.TrainingHParams:
